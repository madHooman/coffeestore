        ...
        <div class="flex flex-col lg:flex-row gap-4 ">
            ...
            <div
                ...
                <div class="w-full dark:bg-zinc-600 cursor-pointer shadow rounded-lg">
                    ...
                    <ul
                        class="accordion-content hidden mx-2 py-2 child:dark:text-gray-200 child:text-gray-600 child:flex items-center child:gap-x-2 child:py-1 child:px-2 child:rounded space-y-2">
                        <li>
                            <label class="cl-checkbox">
                                <input type="checkbox">
                                <span></span>
                            ...
                            <div class="px-2 lg:px-4 mb-3">
                                ...
                                <div class="flex items-center gap-x-1 lg:gap-x-3">
                                    <p class="font-DanaDemiBold text-green-600 dark:text-green-500">
                                        {{$product->product_price}}                                        <span class="font-Dana text-sm">تومان</span>
                                    </p>
